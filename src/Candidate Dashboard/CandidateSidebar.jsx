...
const navItems = [
  { label: 'Dashboard',    path: '/candidate/dashboard',    icon: Icons.dashboard,    badge: null },
  { label: 'Find Jobs',      path: '/candidate/findjobs',         icon: Icons.jobs,         badge: null },
  { label: 'Saved Jobs',   path: '/candidate/jobSection',      icon: Icons.postJob,      badge: null },
  { label: 'My Applications', path: '/candidate/applications', icon: Icons.applications, badge: null },
  { label: 'Settings',     path: '/candidate/settings',     icon: Icons.settings,     badge: null },
]
